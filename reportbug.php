<?php
    ...
    //database panggilan
    $query = mysqli_query($con, "SELECT * FROM report_bug");
                    ...
                    <div class="form1">
                        <div class="form-control" style="margin-top:15px ; padding-bottom:25px ;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="topik_report" placeholder="Something Short" required>
                            </div>
                            <div class="form-group">    
                                <label for="exampleFormControlTextarea1">Description</label>
                                <textarea class="form-control" name="deskripsi_report" placeholder="Write about your post in more detail here" rows="3" required></textarea>
                            </div>
                            <div class="form-group">
                                <div class="mb-3">
                            ...
                            <?php
                                if(isset($_POST['kirim'])){
                                    ...
                                    $topik_report = $_POST['topik_report'];
                                    $deskripsi_report = $_POST['deskripsi_report'];
                                    ...
                                    if($email=='' || $username==''|| $topik_report=='' || $deskripsi_report==''){ 
                                    ...
                                    //query insert list
                                    $queryTambah = mysqli_query($con, "INSERT INTO report_bug (email,username,topik_report,deskripsi_report,image_bukti) VALUES('$email', '$username', '$topik_report', '$deskripsi_report','$new_name')");
