<?php
    ...
    //database report
    $queryReport= mysqli_query($con, "SELECT * FROM report_bug WHERE id_report  = " . $_GET['reportbug']);
    $datareport = mysqli_num_rows($queryReport);


    //database komentar
    $querykomentar = mysqli_query($con,"SELECT * FROM komentar_report WHERE id_report = " . $_GET['reportbug']);
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb" style=" margin-top: 20px; margin-left: 20px;">
            ...
            <li class="breadcrumb-item active" aria-current="page">Detail Report Bug</li>
        </ol>
    </nav>
    ...
    <div class="container mb-3">
            ...
            <?php     
                if(isset($_POST['SubmitKirim'])){
                    ...
                    $queryTambah = mysqli_query($db1, "INSERT INTO komentar_report (username_pengirim,email_pengirim,komentar,id_report) VALUES('$username_pengirim', '$email_pengirim', '$komentar','$id_report')");                                    
                    if($queryTambah){ 
                            ...
                            <div class="media-body">
                                <div class="row">
                                    <div class="col-sm-10">
                                        ...
                                        <div class="col-sm-2">
                                            <a type="button" class="btn btn-primary reply" style="font-size:15px ; cursor:pointer; text-decoration:none; font-weight:bold;" href="balasan_report_komentar.php?balaskomentar=<?php echo $datakomentar['komentar_id']; ?>" > REPLY</a>
                                        </div>
                                </div>
                            </div>
                        </div>
