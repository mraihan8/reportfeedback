<?php
    ...
    //database panggilan
    $query = mysqli_query($con, "SELECT * FROM komentar_report WHERE komentar_id = " . $_GET['balaskomentar']);
    $data = mysqli_fetch_array($query);

    //database komentar
    $querykomentar = mysqli_query($con,"SELECT * FROM komentar_report WHERE komentar_id = " . $_GET['balaskomentar']);
    $datakomentar = mysqli_num_rows($querykomentar);  
    
    //database balasan
    $querybalasan = mysqli_query($con, "SELECT * FROM balasan_report_komentar WHERE komentar_id =  " . $_GET['balaskomentar']);
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="reportbug.php" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="font-weight: bold;"> 
                            Report Bug
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li>
                                <a class="dropdown-item" href="reportbug.php" style="font-weight: bold;">Report Bug</a>
                            </li>
                            <li>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb" style=" margin-top: 20px; margin-left: 20px;">
            ...
            <li class="breadcrumb-item" ><a type="text" style="cursor:pointer; text-decoration:none;" class="breadcrumb-text" href="reportbug.php">Report Bug</a></li>
            <li class="breadcrumb-item" ><a type="text" style="cursor:pointer; text-decoration:none;" class="breadcrumb-text" href="reportbugdetail.php?reportbug=<?php echo $data['id_report']; ?>   ">Detail Report Bug</a></li>
            <li class="breadcrumb-item active" aria-current="page">Form Balasan Komentar Report</li>
        </ol>
    </nav>
            ...
            <div class="nav">
                <div class="judul container" style="margin-bottom:1px ; margin-top:10px;">
                    <div class="row" style="margin-left:15px;">
                        ...
                        <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8" style="float:left ; padding-left:1px;">
                            <h2 style="text-align:start; font-size:25px"><?php echo $datareport['topik_report']; ?></h2>
                        </div>
                ...
                <div class="deskripsi container" style="margin-top:15px; margin-bottom:15px">
                    <div class="row" style="text-align:start ; margin-left:10px;">
                            <h4 style="font-weight:normal; font-size:15px;"><p style="float:left ; font-weight:bold;">Deskrisi: &nbsp;</p><?php echo $datareport['deskripsi_report']; ?></h4>
                    </div>
                </div>
                    <div class="image container" style="margin-top:15px; margin-bottom:5px">
                            <a class="row" style="margin-left:10px ; width:150px;" target="_blank" href="./image/<?php echo $datareport['image_bukti'] ?>">
                                <img src="./image/<?php echo $datareport['image_bukti'] ?>" alt="" >
                            </a>   
                    </div>             
                <div class="username container" style="margin-top:5px; margin-bottom:1px;">
                    <div class="row username" >
                        ...
                        <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" style="float:left ;">
                            <p style="font-weight:normal; text-align:left; font-size:20px;"><?php echo $datareport['username'] ?></p>
                        </div> 
                    </div>
                </div>
            </div>                
    ...
    <div class="container "><hr>
            ...
            <form method="POST" id="form_komentar">
                <div class="form-group">
                    <input type="text" name="username_balasan" id="username_balasan" class="form-control" placeholder="Masukkan Nama" required>
                </div>
                <div class="form-group">
                    <input type="email" name="email_balasan" id="email_balasan" class="form-control" placeholder="Masukkan Email" required>
                </div>
                <div class="form-group">
            ...
            <?php     
                if(isset($_POST['submitbalas'])){
                    ...
                    $queryTambah = mysqli_query($db1, "INSERT INTO balasan_report_komentar (username_balasan,email_balasan,komentar,komentar_id) VALUES('$username_balasan', '$email_balasan', '$komentar','$komentar_id')");                                    
                    if($queryTambah){ 
